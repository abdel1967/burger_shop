...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Orders', 'fa fa-shopping-cart text-success', Order::class);
        ...
        yield MenuItem::linkToCrud('Carriers', 'fa fa-biking text-success', Carrier::class);
        yield MenuItem::linkToCrud('Headers', 'fa fa-desktop text-success', Header::class);
    }
}